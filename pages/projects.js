  ...
  return (
    <div className={`${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-black'} min-h-screen`}>
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="overflow-x-auto">
          <table className={`min-w-full ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} shadow-md rounded-lg overflow-hidden`}>
            ...
            <tbody className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} divide-y ${theme === 'dark' ? 'divide-gray-700' : 'divide-gray-200'}`}>
              {projects.map((project) => (
                <tr key={project.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">{project.language || 'html'}</td>
                  <td className="px-6 py-4 whitespace-nowrap">{new Date(project.createdAt?.seconds * 1000).toLocaleDateString()}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button
                      onClick={() => openDeleteModal(project.id)}
                      className="text-red-600 hover:text-red-800"
            ...
            <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
              ...
              <div className={`inline-block align-bottom ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full`}>
                <div className={`px-4 pt-5 pb-4 sm:p-6 sm:pb-4`}>
                  <div className="sm:flex sm:items-start">
                    <div className="text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <h3 className="text-lg leading-6 font-medium">Create a New Project</h3>
                      <div className="mt-2">
                        <input
                          type="text"
                          placeholder="Enter your project name"
                          value={newProjectName}
                          onChange={(e) => setNewProjectName(e.target.value)}
                          className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 ${theme === 'dark' ? 'bg-gray-700 text-white' : 'bg-gray-100 text-black'} focus:ring-indigo-500 focus:border-transparent`}
                        />
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
              ...
              <div className={`inline-block align-bottom ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full`}>
                <div className={`px-4 pt-5 pb-4 sm:p-6 sm:pb-4`}>
                  <div className="sm:flex sm:items-start">
                    <div className="text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <h3 className="text-lg leading-6 font-medium">Delete Project</h3>
                      <div className="mt-2">
                        <p>Are you sure you want to delete this project? This action cannot be undone.</p>
                      </div>
                    </div>
        ...
        {showToast && (
          <div className={`toast toast-center toast-middle fixed top-0 left-0 right-0 mx-auto mt-5 w-1/2 ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-black'}`}>
            <div className="alert alert-info">
              <span>Project created successfully!</span>
            </div>
          </div>
